                            ...
                            <div class="product-categories-one__inner">
                                <ul>
                                    <li> <a href="#0" class="img-box">
                                            <div class="inner"> <img
                                                    src="@/assets/images/shop/product-categories-v1-img1.png" alt="" />
                                            </div>
                                        </a>
                                    ...
                                    <li> <a href="#0" class="img-box">
                                            <div class="inner"> <img
                                                    src="@/assets/images/shop/product-categories-v1-img2.png" alt="" />
                                            </div>
                                        </a>
                                        <div class="title"> <a href="#0">
                                                <h6>Furnitures</h6>
                                    ...
                                    <li> <a href="#0" class="img-box">
                                            <div class="inner"> <img
                                                    src="@/assets/images/shop/product-categories-v1-img3.png" alt="" />
                                            </div>
                                        </a>
                                        <div class="title"> <a href="#0">
                                                <h6>Jewellery</h6>
                                    ...
                                    <li> <a href="#0" class="img-box">
                                            <div class="inner"> <img
                                                    src="@/assets/images/shop/product-categories-v1-img4.png" alt="" />
                                            </div>
                                        </a>
                                        <div class="title"> <a href="#0">
                                                <h6>Shoes</h6>
                                    ...
                                    <li> <a href="#0" class="img-box">
                                            <div class="inner"> <img
                                                    src="@/assets/images/shop/product-categories-v1-img5.png" alt="" />
                                            </div>
                                        </a>
                                        <div class="title"> <a href="#0">
                                                <h6>Electronics</h6>
                                    ...
                                    <li> <a href="#0" class="img-box">
                                            <div class="inner"> <img
                                                    src="@/assets/images/shop/product-categories-v1-img6.png" alt="" />
                                            </div>
                                        </a>
                                        <div class="title"> <a href="#0">
                                                <h6>Fashion</h6>
                                ...
                                <div class="sidebar-holder">
                                    <form action="#0"
                                        ...
                                        <div class="footer-input-box p-0 "> <input type="email"
                                                ...
                                                class="subscribe_btn"> <i class="flaticon-magnifying-glass"></i>
                                            </button> </div>
                                    </form>
                                                ...
                                                <div v-for="product in products" class="col-xl-4 col-lg-6 col-6 ">
                                                    <div class="products-three-single w-100  mt-30">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        <div class="popup-right-content">
                                                                            ...
                                                                            <div class="price">
                                                                                <h2> грн{{ popupProduct.prise  }} </h2>
                                                                                <h6> In stuck</h6>
                                                                            </div>
                                                                            <div class="color-varient"> 
                                                                                <template v-for="groupProduct in popupProduct.group_products">
                                                                                    <template v-for="color in groupProduct.colors">
                                                                                        <a @click.prevent="getProduct(groupProduct.id)" :style="`background: #${color.title};`" class="color-name"></a>
                                                                                    </template>
                                                                                </template>
                                                                            </div>
                                                        ...
                                                        <div class="products-three-single-content text-center">
                                                            ...
                                                            <p><del>$200.00</del>грн {{ product.prise }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-12 d-flex justify-content-center wow fadeInUp animated">
                                    <ul class="pagination text-center">
                                        <li @click.prevent="getProducts(pagination.current_page - 1)" v-if="pagination.current_page !== 1" class="next"><a href="#0"><i class="flaticon-left-arrows"
                                        ...
                                        <li v-for="link in pagination.links" >
                                            ...
                                            <template v-if="Number(link.label) && (pagination.current_page - link.label === 2) && pagination.current_page !== 3 || Number(link.label) && (pagination.current_page - link.label === -2) && pagination.current_page !== pagination.last_page - 2 ">
                                                <a>...</a>
                                            </template>
                                        </li>
                                        <li v-if="pagination.current_page !== pagination.last_page"  @click.prevent="getProducts(pagination.current_page + 1)" class="next"><a href="#0"><i class="flaticon-next-1" aria-hidden="true"></i>
                                            </a></li>
                                    </ul>
                                </div>
                            </div>
...
name: 'Index',
    ...
    methods: {
        ...
        addToCart(id, isSingle) {
            ...
            if (!cart) {
                localStorage.setItem('cart', JSON.stringify([newProduct])); // Обернути новий об'єкт в масив
            } else {
        ...
        filterProducts(){
            let prises = $('#priceRange').val()

            this.prises = prises.replace(/[\s+]|[$]/g, '').split('-')
        ...
        getFilterList(){
            ...
            .then(res => {
                ...
                if ($("#price-range").length) {
                    $("#price-range").slider({
                    range: true,
                    min: this.filterList.prise.min,
                    max: this.filterList.prise.max,
                    values: [this.filterList.prise.min, this.filterList.prise.max],
