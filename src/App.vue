                  ...
                  <div class="row">
                    <div class="menu-info d-flex justify-content-between align-items-center">
                      <div class="menubar"> <span></span> <span></span> <span></span> </div> <a href="index.html"
                        class="logo"> <img src="@/assets/images/logo/logo.png" alt="Логотип"> </a>
                        ...
                        <div class="right d-flex align-items-center justify-content-end">
                          <ul class="main-menu__widge-box d-flex align-items-center ">
                            ...
                            <li class="d-lg-block d-none"><router-link to="/products/wishlist" class="number"><i
                                  class="flaticon-heart"></i> <span class="count">({{ wishlistLength() }})</span></router-link> </li>
                            <li class="d-lg-block d-none"><router-link to="/products/compare" class="number"><i
                                  class="flaticon-left-and-right-arrows"></i> <span class="count">({{ compareLength() }})</span></router-link> </li>
                            <li class="cartm"> <a href="#0" class="number cart-icon"> <i
                                  class="flaticon-shopping-cart"></i><span class="count">({{  cartLength() }})</span> </a> </li>
                          </ul>
                        </div>
                      </div>
                    </div>
      ...
      <div class="side-cart d-flex flex-column justify-content-between">
        <div class="top">
          <div class="content d-flex justify-content-between align-items-center">
            <h6 class="text-uppercase">Your Cart ({{  cartLength() }}) </h6> <span class="cart-close text-uppercase">X</span>
          </div>
          <div v-for="product in cart" class="items d-flex justify-content-between align-items-center">
            ...
            <div class="right">
              <div class="item-remove"><button @click.prevent="removeCart(product.id)"><i
        ...
        <div class="bottom">
          ...
          <div class="button-box d-flex justify-content-between"> <router-link to="/products/cart" class="button-2 btn_theme"> View Cart
